...
var a = [ORNumber,
    ...
    subtotal3,
    subtotal4]
Customer.addEventListener('show.bs.modal', function(){ //TRIGGER UPON MODAL DISPLAY
...
Customer.addEventListener('change', function(){ //TRIGGER EVERY CONTENT CHANGE INSIDE MODAL
